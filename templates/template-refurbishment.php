<?php /* Template Name: [ Refurbishment ] */
get_header(); 
  ...
  <div class="container">
    <div class="about-banner-text Professionals">
      ...
      { ?><div class="sec2-learn-more">
        ...
        <a href="#contact-us" class="applyBtn animated" data-animation-in="fadeIn" data-delay-in="0.3"><?php the_field('our_banner_button'); ?></a>
      </div>
      <?php
      } ?> 
    </div>
...
<section class="what-we-top-section" id="contact-us">
  <div class="container">
    <div class="row">
      <div class="col-6">
    ...
    <div class="contact-deatil_cover">
      ...
      <div class="col-mid-6">
        <div class="form-cover">
            <?php echo do_shortcode('[contact-form-7 id="1357" title="Contact form 1_refurbishment"]'); ?>
...
<section class="refurbishment-types">
  <div class="container">
    <h2><?php the_field('sec5_title'); ?></h2>
    <div class="usp-refurbishment">
    <?php the_field('sec5_description'); ?>
      <?php
        // Loop through rows.
        while( have_rows('usp_refurbishment') ) : the_row();
...
<section class="our-team-refurbishment about-team-sec1" id="refurbishment-team-section">
            <div class="container">
...
<section class="about-banner2 broker footer-cta" style="background-image:url(<?php if($bannerimage){ echo $bannerimage; } ?>);">
  <div class="container">
    <div class="about-banner-text Professionals">
      ...
      $bannerbtnurl = get_field('our_banner_button_url');
      if($bannerbtnurl)
      { ?><div class="sec2-learn-more-centre">
        <img src="<?php echo get_stylesheet_directory_uri()?>/img/button-arrow.svg" style="width:50px"  alt="icon"/>      
        <a href="#contact-us" class="applyBtn animated" data-animation-in="fadeIn" data-delay-in="0.3"><?php the_field('our_banner_button'); ?></a>
      </div>
      <?php
